...
class MenuHelper
{
    public static function getMainNavItems()
    {
        ...
        // Build User Profile subItems
        $userProfileSubItems = [
            ['name' => ucfirst($role) . ' Profile', 'path' => $path . '/profile', 'pro' => false],
        ];

        // Add Admin Management only for admin
        if ($role === 'admin') {
            $userProfileSubItems[] = ['name' => 'Admin Management', 'path' => '/admin/admin-management', 'pro' => false];
        }

        $votesSubItems = [
            ['name' => 'Create Votes', 'path' => '/admin/create-votes', 'pro' => false],
            ['name' => 'View Votes', 'path' => '/admin/view-votes', 'pro' => false],
        ];
    ...
    public static function getIconSvg($iconName)
    {
        $icons = [
            ...
            'check' => '<svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><circle cx="12" cy="12" r="10" stroke="currentColor" stroke-width="1.75"></circle><path d="M9 12L11 14L15 10" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"></path></svg>',

            'edit' => '<svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M12 20H21" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path><path d="M16.8623 3.48769C17.2984 3.0516 18.0021 3.0516 18.4382 3.48769L20.5123 5.56177C20.9484 5.99786 20.9484 6.70157 20.5123 7.13766L7.38766 20.2623L3 21L3.73769 16.6123L16.8623 3.48769Z" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path></svg>',

            'file-lines' => '<svg class="w-6 h-6 text-gray-800 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24"><path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M10 3v4a1 1 0 0 1-1 1H5m4 8h6m-6-4h6m4-8v16a1 1 0 0 1-1 1H6a1 1 0 0 1-1-1V7.914a1 1 0 0 1 .293-.707l3.914-3.914A1 1 0 0 1 9.914 3H18a1 1 0 0 1 1 1Z"/></svg>',
        ];
