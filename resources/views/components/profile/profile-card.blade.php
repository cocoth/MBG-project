    ...
    <div class="mb-6 rounded-2xl border border-gray-200 p-5 lg:p-6 dark:border-gray-800">
        <div class="flex flex-col gap-5 xl:flex-row xl:items-center xl:justify-between">
            <div class="flex w-full flex-col items-center gap-6 xl:flex-row">
                <div class="size-20 overflow-hidden rounded-full border-2 border-gray-200 dark:border-gray-800">
                    <span
                ...
                <div class="order-3 xl:order-2">
                    ...
                    <div class="flex flex-col items-center gap-1 text-center xl:flex-row xl:gap-3 xl:text-left">
                        ...
                        <p class="text-sm text-gray-500 dark:text-gray-400">
                            Joined {{ isset($user->created_at) ? $user->created_at->format('F j, Y') : 'N/A' }}
                        </p>
                    </div>
                </div>
            </div>
                ...
                <div class="custom-scrollbar overflow-y-auto p-2">
                    <section class="flex flex-col w-full mt-7">
                        ...
                        <div class="flex flex-col gap-5">
                            <section class="flex flex-col gap-3 w-full md:flex-row">
                                <div class="w-full col-span-2 lg:col-span-1">
                                    <label class="mb-1.5 block text-sm font-medium text-gray-700 dark:text-gray-400">
                                        First Name
                                    </label>
                                    <input type="text"
                                        value="{{ explode(' ', $user->name ?? 'Guest')[0] ?? 'Guest' }}"
                                ...
                                <div class="w-full col-span-2 lg:col-span-1">
                                    ...
                                    <input type="text" value="{{ explode(' ', $user->name ?? 'Guest')[1] ?? '' }}"
                            ...
                            <div class="col-span-2 lg:col-span-1">
                                ...
                                <input type="text" value="{{ $user->email ?? 'guest@example.com' }}"
                                    class="dark:bg-dark-900 h-11 w-full appearance-none rounded-lg border border-gray-300 bg-transparent bg-none px-4 py-2.5 text-sm text-gray-800 shadow-theme-xs placeholder:text-gray-400 focus:border-brand-300 focus:outline-hidden focus:ring-3 focus:ring-brand-500/10 dark:border-gray-700 dark:bg-gray-900 dark:text-white/90 dark:placeholder:text-white/30 dark:focus:border-brand-800" />
                            </div>
                        </div>
                    </section>
